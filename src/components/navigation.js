...
const Navigation = () => (
  <nav className={style.navigation} id="navItems">
    ...
    <ul>
      <li><Link to="/" onClick={closeNav}><span className={style.line}></span><b>Home</b></Link></li>
      <li><Link to="/work" onClick={closeNav}><span className={style.line}></span><b>Work</b></Link></li>
      {/*<li><Link to="/blog" classNam><span className={style.line}></span><b>Blog</b></Link></li>*/}
      <li><Link to="/about" onClick={closeNav}><span className={style.line}></span><b>About</b></Link></li>
      <li><Link to="/contact" onClick={closeNav}><span className={style.line}></span><b>Contact</b></Link></li>
    </ul>
